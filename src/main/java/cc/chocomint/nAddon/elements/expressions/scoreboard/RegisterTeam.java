...
public class RegisterTeam extends SimpleExpression<Team> {
	
	private Expression<String> ex_name;
	private Expression<Scoreboard> ex_scoreboard;
	
	static {
		Skript.registerExpression(RegisterTeam.class, Team.class, ExpressionType.COMBINED, "register team named %string% in %scoreboard%");
		Main.Expressions ++;
	}
	...
	@Override
	protected @Nullable Team[] get(Event e) {
